...
contract User{
   ...
   Proposal[] publicProposal; //已经发布过的proposal
    ...
    function storeAddressAccount(address account) public {
    ...
    //user写新的proposals
    function writeNewProposal(uint256 id,
                                ...
                                address _userAccount) public returns(Proposal){
    ...
    //设置发表方案的时间
    function setPublishProposalTime(Proposal _proposal,uint day) public{
